			...
			<div
				...
				<div class="tabbable" id="tabs-801866" style="padding-top:50px">
					<ul class="nav nav-tabs">
						<center>
							<li><a href="#panel-656325" data-toggle="tab">填写管理员信息</a>
							</li>
						</center>
					</ul>
					<div style="margin-left: 35%">

						<form name="myform" action="addAdmin" method="post">
							管理员名：<input type="text" name="adminname" /><br /> 密码：<input
								type="password" name="password" /><br /> 确认密码：<input
								type="password" name="repassword" /><br /> 权限： <select
								name="grade">
								<option>超级管理员</option>
								<option>普通管理员</option>
							</select><br />
